...
import com.ghazi.parks.adapter.CustomInfoWindow;
import com.ghazi.parks.data.Repository;
import com.ghazi.parks.model.Park;
import com.ghazi.parks.model.ParkViewModel;
import com.ghazi.parks.util.Util;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //disable the default dark theme from app
        ...
        Repository.getParks(parks -> {
            ...
            for (Park park : parks) {
                ...
                MarkerOptions markerOptions =
                        new MarkerOptions().position(location).title(park.getName()).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)).snippet(park.getStates());
